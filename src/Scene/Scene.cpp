...
void Scene::drawSolidObjects(XMFLOAT3& leftPos, XMVECTOR& leftRot, XMFLOAT3& rightPos, XMVECTOR& rightRot, float yaw) {
	objectSceneSolid.draw(camera, leftPos, leftRot, rightPos, rightRot, yaw);
}
