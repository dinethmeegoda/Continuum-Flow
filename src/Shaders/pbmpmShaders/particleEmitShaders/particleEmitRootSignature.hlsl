...
"RootConstants(num32BitConstants=30, b0),"     /* 17 constants: w/ one int2, see PBMPM Constants */ \
...
"DescriptorTable(UAV(u3, numDescriptors=2))" /* Table for g_positions & materials */