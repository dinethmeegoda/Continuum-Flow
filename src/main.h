...
static int meshletRenderType = 0; // 0 = realistic, 1 = meshlets, 2 = toon shading
static unsigned int renderModeType = 1; // 0 = just mesh shading, 1 = both particles and mesh shading, 2 = just particles
